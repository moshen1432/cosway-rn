...
export default class Login extends Component{
  ...
  render(){
    const {type1, boxP, vipType,secureTextEntry} = this.state
    ...
    return(
      <ImageBackground  style={styles.bg} source={require('@/images/login/sign_bg.png')}>
          ...
          <View>
            ...
            <View style={styles.row3}>
              <View style={styles.left1}>
                <Text style={styles.text1}>香港 852</Text>
                {arrowImage}
              </View>
        ...
        {/* <TouchableOpacity style={styles.btn} activeOpacity={0.6}>
          <Text style={styles.btnText}>登錄</Text>
        </TouchableOpacity> */}
        <LargeBtn title="登錄"/>
        ...
        <View style={styles.row6}>
          <TouchableOpacity><Text style={styles.regText}>註冊</Text></TouchableOpacity>
        </View>
      </ImageBackground>
    )
  }
